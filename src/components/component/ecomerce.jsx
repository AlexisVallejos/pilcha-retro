              ...
              <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
                <div className="mt-20">
                  ...
                  <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
                    Reviving the football jerseys that made history in their
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Details Of Our Retro Football Shirts
                </h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Made with premium materials and attention to detail, our retro
                  football shirts capture the essence of iconic football
                  moments.
                </p>
              </div>
            </div>
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our shirts are made from high-quality breathable cotton that
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Each design is meticulously recreated to capture the nostalgia
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our shirts are designed with a modern tailored fit to provide
                  a flattering and comfortable look.
                </p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-lg font-bold">Vibrant Colors</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  The colors and fabrics of our shirts are vibrant and
                  realistic, capturing the essence of the era.
                </p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-lg font-bold">Maximum Durability</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our shirts are made to last, with reinforced seams and
              ...
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  These shirts are not only perfect for football fans, but also
                  a statement of retro style.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div className="relative group overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 ease-in-out hover:-translate-y-2 animate-fade-in">
                  ...
                  <div className="bg-white p-4 dark:bg-gray-950">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Iconic Barcelona where they won the 2008-2009 Champions
                      League.
                    </p>
                    <br />
                  </div>
                ...
                <div className="relative group overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 ease-in-out hover:-translate-y-2 animate-fade-in">
                  ...
                  <div className="bg-white p-4 dark:bg-gray-950">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      The powerful Milan squad filled with stars that won the
                      precious Champions League.
                    </p>
                  </div>
                </div>
                <div className="relative group overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 ease-in-out hover:-translate-y-2 animate-fade-in">
                  ...
                  <div className="bg-white p-4 dark:bg-gray-950">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      The famous 86 World Cup where revenge was also taken
                      against the English.
                    </p>
                  </div>
                </div>
